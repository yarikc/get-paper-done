---
name: gpd:review
description: Review the draft locally or with external AI CLIs, then propose a feedback handling plan
...
<process>
Run the review workflow. Use a review stance: findings first, then summary. If `--external` or `--models` is present, collect external feedback, synthesize it into a handling plan, and ask before any revision is applied.
</process>
