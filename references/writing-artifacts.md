...
- `FEEDBACK-PLAN.md`: generated decisions for local/external/reader feedback before revision, with a user override field
...
External review workflows must store reviewer-specific captures under `.paper/feedback-external/`, write the active combined review to `.paper/FEEDBACK-EXTERNAL.md`, and write generated decisions to `.paper/FEEDBACK-PLAN.md`. They must not change `.paper/DRAFT.md`.
