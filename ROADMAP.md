...
Last changed: 2026-05-14 after adding import-time source-reference triage to `gpd import`.
...
32. Next main-line slice: continue import hardening where real use needs it, likely PDF/spreadsheet handling or version/source indexing, before returning to Gemini/opencode provider calibration.
