...
- The next validator improvement should warn when recurring terms appear repeatedly before a near-first-use definition.
...
- Define-before-reuse warning for recurring terms that are not defined near first use. Implemented as a MEDIUM recurring-term warning.
