# Weekly Platform Update Example

This is a compact completed GPD workspace for a low-risk internal update.

It shows the lightweight end of the workflow:

- clear audience and brief
- strategy gate set to `Go`
- lite outline
- short draft
- review and export
- no canonical `RESEARCH.json`
- no `FACT-CHECK.md`
