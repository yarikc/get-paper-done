...
1. Real-paper behavior now has five examples, but still not enough breadth. Deterministic public-source claim-support metadata exists; the next evidence gap is live public-source verification on a real paper and messier import extraction.
