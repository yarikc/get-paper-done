...
- [examples/software-supply-chain-evidence-pack](examples/software-supply-chain-evidence-pack) shows a pre-registered public-source decision memo using CISA, NIST, SLSA, and OpenSSF sources to test supply-chain evidence claims, process-burden handling, fact-checking, review, and export.
